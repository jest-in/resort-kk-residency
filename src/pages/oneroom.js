...
export default function OneRoom() {
  ...
  const [imageUrl,setImageUrl]=useState(cat1);
    return (
      <div className="container">
        ...
        <main className="singleroom-main">
          <div className="single-room-head">
            ...
            <div className="singleroom-image-thumb">
              <figure className="singleroom-thumb-container">
                <img
                  onClick={() => setImageUrl(thumb1)}
                  src={thumb1}
                  alt="room category"
                  className="singleroom-thumb1"
                />
                <img
                  onClick={() => setImageUrl(thumb2)}
                  src={thumb2}
                  alt="room category"
            ...
            <div className="singleroom-desc-div">
              ...
              <div className="singleroom-desc">
                <p>
                  ...
                  beatae vitae. Perched atop a quaint hill, The Mudhouse is
                  surrounded by the spectacular landscapes of Sahayadri,
                  offering an epic panorama of the valley of Marayoor. Close to
                  the treasured Sandalwood forest and Chinnar Wildlife
                  Sanctuary. Here, time moves unhurriedly, slowly painting the
                  sky a different hue each passing hour. The eco-friendly
                  constructed cottages and treehouse reflect barefoot luxury,
                  helping you stay rooted to Earth but still be close to Heaven.
                </p>
                <hr />
              </div>
          ...
          <section className="whatitoffers-div">
            <h2 className="whatitoffers-heading">What this place offers</h2>
            <ul className="whatitoffers-container">
              <div>
                <li className="whatitoffers-items">Garden View</li>
                <li className="whatitoffers-items">Dedicated Workspace</li>
                <li className="whatitoffers-items">Free parking on premises</li>
              </div>
              <div>
                <li className="whatitoffers-items">Patio or Balcony</li>
                <li className="whatitoffers-items">Garden</li>
                <li className="whatitoffers-items">Luggage drop-off allowed</li>
              </div>
            </ul>
          </section>
            ...
            <div className="singleroom-review-content">
              <article className="singleroom-review-container">
                ...
                <p className="singleroom-review-text">
                  This is one of the best properties I have ever stayed, and
                  what makes it special is their hospitality. Guest relation at
                  its best and special mention to Ambili the care taker.
                </p>
              </article>
              <article className="singleroom-review-container">
                <header className="singleroom-review-person-data">
          ...
          <hr className="whatitoffers-hr" />
          <section className="singleroom-reviews-div">
            <h2 className="singleroom-reviews-heading">Where you’ll be</h2>
              ...
              <section className="house-rules-sec">
                ...
                <ul className="things-to-know-container">
                  <li className="things-toknow-items">
                    Check-in:{" "}
                    <time dateTime="12:00" className="things-toknow-items">
                      12:00 pm
                    </time>{" "}
                    -{" "}
                    <time dateTime="17:00" className="things-toknow-items">
                      5:00 pm
                    </time>
                  </li>
                  <li className="things-toknow-items">No smoking</li>
                  <li className="things-toknow-items">No pets</li>
                  <li className="things-toknow-items">No parties or events</li>
                </ul>
              </section>
              <section className="house-rules-sec">
                <h3 className="houserules-text">Cancellation policy</h3>
                <p className="things-toknow-items">
                  Your money will be fully refunded if cancelled before 3 days.
                </p>
              </section>
            </div>
          </section>
